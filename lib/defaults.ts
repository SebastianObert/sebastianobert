...
export const DEFAULT_SKILLS: Skill[] = [
  ...
  { name: "C#", icon: "https://cdn.simpleicons.org/csharp/9B4F96", iconType: "simpleicons_url", category: "Game Development", sortOrder: 3 },
