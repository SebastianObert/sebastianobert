        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20">
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-6 justify-center md:justify-start">
              ...
              <a 
                href="#projects" 
                className="w-[160px] sm:w-[180px] px-6 sm:px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-full font-medium transition shadow-lg shadow-cyan-500/30 flex items-center justify-center gap-2 text-sm sm:text-base"
              >
                View My Works
              ...
              <a 
                href="#contact" 
                className="w-[160px] sm:w-[180px] px-6 sm:px-8 py-3 border border-slate-600 hover:border-cyan-400 hover:text-cyan-400 rounded-full font-medium transition flex items-center justify-center gap-2 text-sm sm:text-base"
              >
                Contact Me
